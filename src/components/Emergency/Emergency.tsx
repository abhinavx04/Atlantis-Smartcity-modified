  ...
  return (
    <div className="min-h-screen bg-black relative overflow-hidden">
      ...
      <main className="container mx-auto px-4 pt-16 relative z-10">
        ...
        {/* Live Alerts Section - Now after Report Emergency */}
        <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl p-4 mb-8 border border-gray-700/50">
          <h2 className="text-xl font-['Syncopate'] text-white mb-4 flex items-center">
        ...
        <div className="bg-gray-800/40 backdrop-blur-sm rounded-xl p-6 mb-8 border border-gray-700/50">
          <h2 className="text-2xl font-['Syncopate'] text-white mb-6">
            EMERGENCY GUIDES
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            >
              <h3 className="text-xl text-blue-400 mb-4 font-semibold">CPR Guide</h3>
            ...
            >
              <h3 className="text-xl text-red-400 mb-4 font-semibold">Fire Safety</h3>
            ...
            >
              <h3 className="text-xl text-green-400 mb-4 font-semibold">Cut & Wound Care</h3>
              <ul className="space-y-3 text-gray-300 text-sm">
                <li className="flex items-start gap-2">
            ...
            {/* Women's Safety Guidelines */}
            <motion.div
              whileHover={{ scale: 1.02 }}
              className="bg-gray-900/50 p-6 rounded-xl border border-pink-500/20"
            >
              <h3 className="text-xl text-pink-400 mb-4 font-semibold">Women's Safety Guide</h3>
              <ul className="space-y-3 text-gray-300 text-sm">
                <li className="flex items-start gap-2">
                ...
                <li className="flex items-start gap-2">
                  <span className="text-pink-400">•</span>
                  Keep emergency contacts on speed dial (Women Helpline: 1091)
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-pink-400">•</span>
                  Share live location with trusted contacts when traveling
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-pink-400">•</span>
                  Document harassment incidents (photos, videos if safe to do so)
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-pink-400">•</span>
                  Use safety apps and keep them easily accessible
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-pink-400">•</span>
            ...
            >
              <h3 className="text-xl text-purple-400 mb-4 font-semibold">Heart Attack Signs</h3>
              <ul className="space-y-3 text-gray-300 text-sm">
                <li className="flex items-start gap-2">
            ...
            <motion.div
              whileHover={{ scale: 1.02 }}
              className="bg-gray-900/50 p-6 rounded-xl border border-cyan-500/20"
            >
              <h3 className="text-xl text-cyan-400 mb-4 font-semibold">Natural Disaster</h3>
              <ul className="space-y-3 text-gray-300 text-sm">
                <li className="flex items-start gap-2">
